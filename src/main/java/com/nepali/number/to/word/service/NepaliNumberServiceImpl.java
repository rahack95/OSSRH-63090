...
import com.nepali.number.to.word.constant.NepaliNumberConstant;
import com.nepali.number.to.word.model.NepaliNumberToWord;
 ...
 * @since 29 Dec 2020
 */
public class NepaliNumberServiceImpl implements NepaliNumberService {
  ...
  private void updateNumberAndSpecifiedDigitPlace(Integer digitPlace, NepaliNumberToWord nepaliNumberToWord) {
    nepaliNumberToWord.setQuotient(nepaliNumberToWord.getNumber().divide(nepaliNumberToWord.getDivisor(), 0, RoundingMode.DOWN));
